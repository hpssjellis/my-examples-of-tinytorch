...
// Check TinyTorch installation
$titoVersion = runCommandCheck('python -c "import tinytorch; print(f\'TinyTorch available at: {tinytorch.__file__}\')"');
...
print("Testing TinyTorch imports...")
print()

try:
    import tinytorch
    print("✓ tinytorch module imported successfully")
    print(f"  Location: {tinytorch.__file__}")
    print()
    
    from tinytorch import Tensor
    print("✓ Tensor class imported successfully")
    
    # List available modules
    import pkgutil
    print()
    print("Available TinyTorch modules:")
    for importer, modname, ispkg in pkgutil.iter_modules(tinytorch.__path__):
        print(f"  - {modname}")
...
PYTHON;
        ...
        $checkResult = "<b style='color:blue'>TinyTorch Import Test Complete!</b>";
    }
}
    ...
    <div class="container">
        ...
        <div class="results-box">
            ...
            <p><strong>TinyTorch:</strong> <code><?php echo htmlspecialchars($titoVersion); ?></code>
                <?php echo (strpos($titoVersion, 'TinyTorch available') === 0) ? '<span class="badge badge-success">✓ Installed</span>' : '<span class="badge badge-danger">✗ Not Found</span>'; ?>
            </p>
        </div>
